...
initFrame:SetScript("OnEvent", function(self)
    ...
    local function BuildUnitPreview(parent, unitKey, side)
        ...
        function pf:Update()
            ...
            EllesmereUI.ApplyBorderStyle(border, bs, bc.r, bc.g, bc.b, PB("borderAlpha") or 1, bTexKey, PB("borderTextureOffset"), PB("borderTextureOffsetY"), PB("borderTextureShiftX"), PB("borderTextureShiftY"), "unitframes", bs)
            ...
            if border then
                ...
                EllesmereUI.ApplyBorderStyle(border, bs2, bc2.r, bc2.g, bc2.b, PB("borderAlpha") or 1, bTex2, PB("borderTextureOffset"), PB("borderTextureOffsetY"), PB("borderTextureShiftX"), PB("borderTextureShiftY"), "unitframes", bs2)
            end
            if castbar then
